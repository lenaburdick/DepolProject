...
% This code has an error becauses the protein position is allowed to go into negative numbers
...
fileID3 = fopen('draft.sp.filamentlength.onesided.cluster.txt','a'); 

...
%This code was copy and pasted from Tracy_Main.m
...
%-Rates------------------------------------------------------------------
kLand=0; %Chance of a single motor falling on filament. true kOn is kOn*NumberofFreeMotors*LengthofFilament
kAssist=0; 
...
kUnassisted=.0417; %monomers/sec % Chance filament will depolymerize without a protein at the end
...
y=(StartingLength-(0:ShrinkAmount))*MonomerMeasurement;
